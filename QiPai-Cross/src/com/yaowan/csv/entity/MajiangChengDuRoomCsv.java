...
//
public class MajiangChengDuRoomCsv {
	/**
	 * 
	 */
	private int roomID;
	 ...
	 * 
	 */
	private int straightBar;
	
	/**
	 * 
	 */
	private int bendingBar;
	
	/**
	 * 
	 */
	private int darkBars;
	...
	public int getStraightBar() {
		return straightBar;
	}

	public void setStraightBar(int straightBar) {
		this.straightBar = straightBar;
	}
	
	public int getBendingBar() {
		return bendingBar;
	}

	public void setBendingBar(int bendingBar) {
		this.bendingBar = bendingBar;
	}
	
	public int getDarkBars() {
		return darkBars;
	}

	public void setDarkBars(int darkBars) {
		this.darkBars = darkBars;
	}
	
	public int getMyDraw() {
		return myDraw;
	}

	public void setMyDraw(int myDraw) {
		this.myDraw = myDraw;
	}
