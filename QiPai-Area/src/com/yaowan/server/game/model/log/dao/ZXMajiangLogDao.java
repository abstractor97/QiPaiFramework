 ...
 */
@Component
public class ZXMajiangLogDao extends SingleKeyLogDao<ZXMajiangLog, Long> {
	 ...
	 * @throws Exception
	 */
	public void addLog(ZXMajiangLog majiangLog) {
	 ...
	 * @return
	 */
	public ZXMajiangLog getMajiangLog(Game game, String roleInfos,
			String roleInfoDetail, String winners, int aiGold, int totalMemberCount, int realPlayerCount) {
		ZXMajiangLog log = new ZXMajiangLog();
