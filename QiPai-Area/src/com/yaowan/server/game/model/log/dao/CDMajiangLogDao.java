 ...
 */
@Component
public class CDMajiangLogDao extends SingleKeyLogDao<CDMajiangLog, Long> {
	 ...
	 * @throws Exception
	 */
	public void addLog(CDMajiangLog majiangLog) {
	 ...
	 * @return
	 */
	public CDMajiangLog getMajiangLog(Game game, String roleInfos,
			String roleInfoDetail, String winners, int aiGold, int totalMemberCount, int realPlayerCount) {
		CDMajiangLog log = new CDMajiangLog();
