 ...
 */
@Component
public class MajiangWaitDingQueTypeEvent extends EventHandlerAdapter{
	...
	public int execute(Event event) {
		...
		zxmajiangFunction.setMemberQueType(table);
		return 0;
	}

	@Override
	public int getHandle() {
		return HandleType.MAJIANG_WAIT_DING_QUE_TYPE;
	}
}
