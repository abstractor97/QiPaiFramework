 ...
 */
@Component
public class MenjiCompeteEvent extends EventHandlerAdapter {
	...
	public int execute(Event event) {
		...
		int target = menjiFunction.pkSeat(table, role.getRole());
		menjiFunction.dealCompete(table, role, target);
	...
	public int getHandle() {
		return HandleType.MENJI_COMPETE;
	}
