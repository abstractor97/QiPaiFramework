 ...
 */
@Component
public class MajiangGangEvent extends EventHandlerAdapter{
	...
	public int execute(Event event) {
		...
		if (table.getGame().getGameType() == GameType.MAJIANG) {
			...
			zxmajiangFunction.dealGang(table, role);	
		} else if (table.getGame().getGameType() == GameType.CDMAJIANG) {
			cdmajiangFunction.dealGang(table, role);	
		}	
	...
	public int getHandle() {
		return HandleType.MAJIANG_GANG;
	}
